    ...
    fn handle_response_item(&mut self, item: &codex_protocol::models::ResponseItem) {
        match item {
            ...
            codex_protocol::models::ResponseItem::FunctionCall {
                ...
                self.push_item_in_current_turn(ThreadItem::FunctionCall {
            ...
            codex_protocol::models::ResponseItem::FunctionCallOutput {
                ...
                self.push_item_in_current_turn(ThreadItem::FunctionCallOutput {
                    call_id: call_id.clone(),
                    output: output.clone(),
                });
            }
            codex_protocol::models::ResponseItem::CustomToolCall {
                ...
                self.push_item_in_current_turn(ThreadItem::CustomToolCall {
                    call_id: call_id.clone(),
                    name: name.clone(),
                    input: input.clone(),
                    status: status.clone(),
            ...
            codex_protocol::models::ResponseItem::CustomToolCallOutput {
                ...
                self.push_item_in_current_turn(ThreadItem::CustomToolCallOutput {
                    call_id: call_id.clone(),
                    name: name.clone(),
                    output: output.clone(),
                });
