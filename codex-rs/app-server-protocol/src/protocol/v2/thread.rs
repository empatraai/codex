...
pub struct ThreadResumeParams {
    ...
    #[ts(optional = nullable)]
    pub personality: Option<Personality>,
    /// Optional dynamic tools to expose after resuming the thread.
    ///
    /// Omitted keeps the tools persisted in the thread history. Non-empty
    /// values override the persisted set for this live resume, matching
    /// `thread/start.dynamicTools` validation and normalization.
