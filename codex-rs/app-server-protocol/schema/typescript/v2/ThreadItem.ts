 ...
 */
durationMs: number | null, } | { "type": "function_call", call_id: string, name: string, namespace?: string, arguments: string, } | { "type": "function_call_output", call_id: string, output: FunctionCallOutputBody, } | { "type": "custom_tool_call", call_id: string, name: string, input: string, status?: string, } | { "type": "custom_tool_call_output", call_id: string, name?: string, output: FunctionCallOutputBody, } | { "type": "collabAgentToolCall",
/**
